...
function brookFourierTransform(bufferSize, sampleRate) {
 ...
 * @constructor
 */
function brookFFT(bufferSize, sampleRate) {
  brookFourierTransform.call(this, bufferSize, sampleRate);
 ...
 */
brookFFT.prototype.forward = function(buffer) {
...
brookFFT.prototype.inverse = function(real, imag) {
  // Locally scope variables for speed up
  var bufferSize      = this.bufferSize,
      cosTable        = this.cosTable,
      sinTable        = this.sinTable,
